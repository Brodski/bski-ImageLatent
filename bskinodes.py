...
class BskiNode(io.ComfyNode):
    ...
    def define_schema(cls) -> io.Schema:
        ...
        return io.Schema(
            node_id="BskiNode",
            display_name="BskiNode 420 Node",
    ...
    def execute(cls, image, string_field, int_field, float_field, print_to_screen) -> io.NodeOutput:
        logging.info("BSKI EXECUTE!!!!!!")
        logging.info("BSKI EXECUTE!!!!!!")
        logging.info(image)
        logging.info(string_field)
        logging.info(int_field)
        logging.info(float_field)
        logging.info(print_to_screen)
